...
public class Main {
	 ...
	 */
	public Main() throws RemoteException, NamingException {
		initialize();
		remote = lookUpUser();
        load();
	}
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 669, 423);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				remote.create(new User(txtNom.getText(),txtPrenom.getText(),txtEmail.getText(),new Date(),txtTelephone.getText()));
				try {
					load();
		...
		btnUpdate.setBounds(500, 83, 89, 23);
		panel.add(btnUpdate);
		...
		btnDelete.setBounds(500, 126, 89, 23);
		panel.add(btnDelete);
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				txtDate.setText(model.getValueAt(table.getSelectedRow(), 5).toString());
			}
		});
		...
		txtDate.setBounds(154, 132, 198, 20);
		panel.add(txtDate);
	}
}
